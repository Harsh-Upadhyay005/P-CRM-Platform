...
import { MapPin, TrendingUp, AlertTriangle, Shield, ChevronRight, RefreshCw } from 'lucide-react';
...
const BASE_INDIA_STATES: StateData[] = [
  { id: 'JK', name: 'Jammu & Kashmir', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Srinagar', complaints: 0, lat: 34.08, lng: 74.79 }, { name: 'Jammu', complaints: 0, lat: 32.73, lng: 74.87 }] },
  { id: 'HP', name: 'Himachal Pradesh', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Shimla', complaints: 0, lat: 31.1, lng: 77.17 }, { name: 'Dharamsala', complaints: 0, lat: 32.22, lng: 76.32 }] },
  { id: 'PB', name: 'Punjab', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Chandigarh', complaints: 0, lat: 30.73, lng: 76.78 }, { name: 'Amritsar', complaints: 0, lat: 31.63, lng: 74.87 }, { name: 'Ludhiana', complaints: 0, lat: 30.9, lng: 75.85 }] },
  { id: 'UK', name: 'Uttarakhand', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Dehradun', complaints: 0, lat: 30.32, lng: 78.03 }, { name: 'Haridwar', complaints: 0, lat: 29.95, lng: 78.16 }] },
  { id: 'HR', name: 'Haryana', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Gurugram', complaints: 0, lat: 28.46, lng: 77.03 }, { name: 'Faridabad', complaints: 0, lat: 28.41, lng: 77.31 }] },
  { id: 'DL', name: 'Delhi', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'New Delhi', complaints: 0, lat: 28.61, lng: 77.21 }, { name: 'Dwarka', complaints: 0, lat: 28.59, lng: 77.04 }, { name: 'Rohini', complaints: 0, lat: 28.74, lng: 77.11 }] },
  { id: 'RJ', name: 'Rajasthan', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Jaipur', complaints: 0, lat: 26.92, lng: 75.79 }, { name: 'Jodhpur', complaints: 0, lat: 26.24, lng: 73.02 }, { name: 'Udaipur', complaints: 0, lat: 24.58, lng: 73.68 }] },
  { id: 'UP', name: 'Uttar Pradesh', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Lucknow', complaints: 0, lat: 26.85, lng: 80.95 }, { name: 'Noida', complaints: 0, lat: 28.57, lng: 77.32 }, { name: 'Varanasi', complaints: 0, lat: 25.32, lng: 83.01 }, { name: 'Agra', complaints: 0, lat: 27.18, lng: 78.02 }] },
  { id: 'BR', name: 'Bihar', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Patna', complaints: 0, lat: 25.6, lng: 85.1 }, { name: 'Gaya', complaints: 0, lat: 24.8, lng: 85.0 }] },
  { id: 'SK', name: 'Sikkim', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Gangtok', complaints: 0, lat: 27.33, lng: 88.62 }] },
  { id: 'AR', name: 'Arunachal Pradesh', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Itanagar', complaints: 0, lat: 27.1, lng: 93.62 }] },
  { id: 'NL', name: 'Nagaland', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Kohima', complaints: 0, lat: 25.67, lng: 94.11 }, { name: 'Dimapur', complaints: 0, lat: 25.91, lng: 93.73 }] },
  { id: 'MN', name: 'Manipur', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Imphal', complaints: 0, lat: 24.82, lng: 93.95 }] },
  { id: 'MZ', name: 'Mizoram', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Aizawl', complaints: 0, lat: 23.73, lng: 92.72 }] },
  { id: 'TR', name: 'Tripura', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Agartala', complaints: 0, lat: 23.83, lng: 91.28 }] },
  { id: 'ML', name: 'Meghalaya', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Shillong', complaints: 0, lat: 25.57, lng: 91.88 }] },
  { id: 'AS', name: 'Assam', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Guwahati', complaints: 0, lat: 26.14, lng: 91.74 }, { name: 'Dibrugarh', complaints: 0, lat: 27.47, lng: 94.91 }] },
  { id: 'WB', name: 'West Bengal', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Kolkata', complaints: 0, lat: 22.57, lng: 88.36 }, { name: 'Siliguri', complaints: 0, lat: 26.71, lng: 88.43 }, { name: 'Durgapur', complaints: 0, lat: 23.55, lng: 87.32 }] },
  { id: 'JH', name: 'Jharkhand', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Ranchi', complaints: 0, lat: 23.34, lng: 85.31 }, { name: 'Jamshedpur', complaints: 0, lat: 22.8, lng: 86.2 }] },
  { id: 'OD', name: 'Odisha', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Bhubaneswar', complaints: 0, lat: 20.3, lng: 85.82 }, { name: 'Cuttack', complaints: 0, lat: 20.46, lng: 85.89 }] },
  { id: 'CT', name: 'Chhattisgarh', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Raipur', complaints: 0, lat: 21.25, lng: 81.63 }, { name: 'Bilaspur', complaints: 0, lat: 22.08, lng: 82.15 }] },
  { id: 'MP', name: 'Madhya Pradesh', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Bhopal', complaints: 0, lat: 23.26, lng: 77.41 }, { name: 'Indore', complaints: 0, lat: 22.72, lng: 75.86 }, { name: 'Jabalpur', complaints: 0, lat: 23.18, lng: 79.95 }] },
  { id: 'GJ', name: 'Gujarat', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Ahmedabad', complaints: 0, lat: 23.02, lng: 72.57 }, { name: 'Surat', complaints: 0, lat: 21.17, lng: 72.83 }, { name: 'Vadodara', complaints: 0, lat: 22.31, lng: 73.19 }] },
  { id: 'MH', name: 'Maharashtra', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Mumbai', complaints: 0, lat: 19.08, lng: 72.88 }, { name: 'Pune', complaints: 0, lat: 18.52, lng: 73.86 }, { name: 'Nagpur', complaints: 0, lat: 21.15, lng: 79.09 }, { name: 'Nashik', complaints: 0, lat: 20.0, lng: 73.79 }] },
  { id: 'GA', name: 'Goa', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Panaji', complaints: 0, lat: 15.5, lng: 73.83 }, { name: 'Margao', complaints: 0, lat: 15.28, lng: 73.96 }] },
  { id: 'KA', name: 'Karnataka', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Bengaluru', complaints: 0, lat: 12.97, lng: 77.59 }, { name: 'Mysuru', complaints: 0, lat: 12.3, lng: 76.65 }, { name: 'Hubli', complaints: 0, lat: 15.36, lng: 75.12 }] },
  { id: 'KL', name: 'Kerala', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Thiruvananthapuram', complaints: 0, lat: 8.52, lng: 76.94 }, { name: 'Kochi', complaints: 0, lat: 9.93, lng: 76.27 }, { name: 'Kozhikode', complaints: 0, lat: 11.25, lng: 75.77 }] },
  { id: 'TN', name: 'Tamil Nadu', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Chennai', complaints: 0, lat: 13.08, lng: 80.27 }, { name: 'Coimbatore', complaints: 0, lat: 11.02, lng: 76.96 }, { name: 'Madurai', complaints: 0, lat: 9.92, lng: 78.12 }] },
  { id: 'AP', name: 'Andhra Pradesh', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Visakhapatnam', complaints: 0, lat: 17.69, lng: 83.22 }, { name: 'Vijayawada', complaints: 0, lat: 16.51, lng: 80.65 }, { name: 'Tirupati', complaints: 0, lat: 13.63, lng: 79.42 }] },
  { id: 'TS', name: 'Telangana', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Hyderabad', complaints: 0, lat: 17.38, lng: 78.49 }, { name: 'Warangal', complaints: 0, lat: 17.98, lng: 79.6 }, { name: 'Nizamabad', complaints: 0, lat: 18.67, lng: 78.09 }] },
  { id: 'LD', name: 'Lakshadweep', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Kavaratti', complaints: 0, lat: 10.57, lng: 72.64 }] },
  { id: 'AN', name: 'Andaman & Nicobar', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Port Blair', complaints: 0, lat: 11.67, lng: 92.74 }] },
  { id: 'LA', name: 'Ladakh', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Leh', complaints: 0, lat: 34.15, lng: 77.58 }] },
  { id: 'PY', name: 'Puducherry', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Puducherry', complaints: 0, lat: 11.93, lng: 79.83 }] },
  { id: 'CH', name: 'Chandigarh', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Chandigarh', complaints: 0, lat: 30.73, lng: 76.78 }] },
  { id: 'DN', name: 'Dadra & Nagar Haveli', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Silvassa', complaints: 0, lat: 20.27, lng: 73.01 }] },
  { id: 'DD', name: 'Daman & Diu', complaints: 0, resolved: 0, pending: 0, critical: 0, cities: [{ name: 'Daman', complaints: 0, lat: 20.41, lng: 72.85 }] },
];
...
const STATE_MAPPING: Record<string, string> = {
  'INAN': 'AN', 'INAP': 'AP', 'INAR': 'AR', 'INAS': 'AS', 'INBR': 'BR',
  'INCH': 'CH', 'INCT': 'CT', 'INDH': 'DN', 'INDL': 'DL', 'INGA': 'GA',
  'INGJ': 'GJ', 'INHR': 'HR', 'INHP': 'HP', 'INJH': 'JH', 'INKA': 'KA',
  'INKL': 'KL', 'INLD': 'LD', 'INMP': 'MP', 'INMH': 'MH', 'INMN': 'MN',
  'INML': 'ML', 'INMZ': 'MZ', 'INNL': 'NL', 'INOR': 'OD', 'INPY': 'PY',
  'INPB': 'PB', 'INRJ': 'RJ', 'INSK': 'SK', 'INTN': 'TN', 'INTG': 'TS',
...
export function IndiaMapView() {
  ...
  const fetchMapStats = useCallback(async () => {
    ...
    try {
      ...
      const apiLookup: Record<string, { complaints: number; resolved: number; pending: number; critical: number }> = {};
      for (const s of apiStates) {
        apiLookup[s.id] = { complaints: s.complaints, resolved: s.resolved, pending: s.pending, critical: s.critical };
      }

      // Merge API data into base states; distribute state-level complaints
      // proportionally across cities (equal distribution as a simple heuristic)
      const merged: StateData[] = BASE_INDIA_STATES.map((base) => {
        const data = apiLookup[base.id];
        if (!data || data.complaints === 0) return base;

        const n = base.cities.length || 1;
        const basePerCity = Math.floor(data.complaints / n);
        const remainder = data.complaints % n;

        const updatedCities = base.cities.map((city, idx) => ({
          ...city,
          complaints: basePerCity + (idx === 0 ? remainder : 0),
        }));
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      { opacity: 1, scale: 1, duration: 0.6, stagger: { each: 0.03, from: 'center' }, ease: 'power2.out' },
    );
    gsap.fromTo(
      statePulses,
      { opacity: 0, scale: 0, transformOrigin: 'center center' },
      { opacity: 1, scale: 1, duration: 0.6, stagger: 0.03, delay: 0.5, ease: 'back.out(2)' },
    );
  }, [isLoading, stateData]);
          ...
          <>
            {loadError && (
              <div className="mb-3 px-3 py-2 rounded-lg bg-red-500/10 border border-red-500/20 text-xs text-red-400 flex items-center gap-2">
                ...
                <button onClick={fetchMapStats} className="underline ml-1">Retry</button>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
              ...
              <div ref={containerRef} className="lg:col-span-8 relative">
                <div className="relative bg-slate-900/50 rounded-xl border border-white/5 p-4 overflow-hidden">
                  ...
                  <svg ref={mapRef} viewBox="0 0 460 520" className="w-full h-auto max-h-130" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                    ...
                    {stateData.map((state) => {
                      ...
                      const isHovered = hoveredState === state.id;
                      const isSelected = selectedState === state.id;
                      const dotRadius = Math.max(1.5, Math.min((state.complaints / maxComplaints) * 8, 8));

                      return (
                        <g key={`dot-${state.id}`} className="state-pulse" style={{ pointerEvents: 'none' }}>
                          {state.complaints > 0 && (
                            <circle className="pulse-ring-state" cx={cx} cy={cy} r={dotRadius} fill="none" stroke="#FF9933" strokeWidth={1} opacity={0.6} />
                          )}
                          {state.complaints > 0 && (
                            <circle
                              cx={cx} cy={cy}
                          ...
                          {(isHovered || isSelected) && state.complaints > 0 && (
                            <text
                              x={cx + dotRadius + 4} y={cy + 3}
                              fill="#fff" fontSize="8" fontWeight="bold" fontFamily="monospace"
                  ...
                  <div className="bg-white/[0.03] rounded-xl border border-white/5 p-4">
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-3">
                      ...
                      <div className="bg-white/5 rounded-lg p-2.5 text-center">
                        <p className="text-lg font-bold text-emerald-400 font-mono">
                          {selectedData.complaints > 0 ? Math.round((selectedData.resolved / selectedData.complaints) * 100) : 0}%
                        </p>
                    ...
                    <div className="border-t border-white/5 pt-3">
                      ...
                      {selectedData.cities.map((city) => {
                        const pct = selectedData.complaints > 0 ? (city.complaints / selectedData.complaints) * 100 : 0;
                        return (
