            ...
            >
              ...
              <div
                className={clsx(
                  ...
                  isActive
                    ? "h-full bg-linear-to-b from-[#FF9933] to-[#138808]"
                    : "h-0 bg-white/20 group-hover:h-1/2 group-hover:bg-[#138808]/50",
                )}
              />
              ...
              <link.icon
                ...
                className={clsx(
                  ...
                  isActive
                    ? "text-[#FF9933] scale-110 drop-shadow-[0_0_8px_rgba(255,153,51,0.5)]"
                    : "text-slate-500 group-hover:text-[#FFFFFF] group-hover:scale-110",
                )}
              />
